...
void DrawLevel1() {
	...
	// Timer Display
	int timerMins = (int)(levelTimer / 60);
	int timerSecs = (int)(levelTimer) % 60;
	char timerStr[20];
	sprintf_s(timerStr, "%d:%02d", timerMins, timerSecs);
	if (levelTimer < 30) SetColor(255, 50, 50, 255);
	else SetColor(200, 200, 255, 255);
	iText(SCREEN_WIDTH / 2 - 20, SCREEN_HEIGHT - 50, timerStr, GLUT_BITMAP_TIMES_ROMAN_24);
